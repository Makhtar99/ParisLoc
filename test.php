...
<body>
    ...
    <div class="container">
        ...
        <div id="div3" class="past">carre carre 
        </div>
...
<script >
  ...
  function setActiveElement(element) {
    ...
    var navBarRect = activeElement.parentNode.getBoundingClientRect();
  ...
  function handleClick(event) {
    ...
    if (clickedElement.classList.contains('element')) {
      ...
      showDiv(clickedElement.textContent);
    }
  }
  ...
  function showDiv(tabName) {
    ...
    if (tabName === 'Mes réservations') {
      div1.style.display = 'none';
      div2.style.display = 'block';
      div3.style.display = 'none';
      div4.style.display = 'none';
    } else if (tabName === 'Mes réservations passées') {
      div1.style.display = 'none';
      div2.style.display = 'none';
      div3.style.display = 'block';
      div4.style.display = 'none';
    } else if (tabName === 'Messagerie') {
      div1.style.display = 'none';
      div2.style.display = 'none';
      div3.style.display = 'none';
  ...
  var defaultTab = document.querySelector('.element');
  if (defaultTab) {
    setActiveElement(defaultTab);
    showDiv(defaultTab.textContent);
  }
});
